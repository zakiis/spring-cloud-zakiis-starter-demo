...
public class AuthController {
	...
	public CommonResp<String> login(@RequestBody @Valid LoginRequest reqeust) {
	...
	public CommonResp<String> sendCode(@RequestParam String phone) {
		return CommonResp.success(RandomStringUtils.randomNumeric(4));
	}
}
